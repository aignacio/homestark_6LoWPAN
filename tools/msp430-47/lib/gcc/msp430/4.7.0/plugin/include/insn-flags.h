...
#define HAVE_extend8bitpsi1 (TARGET_CPUX)
#define HAVE_extend8bithi1 1
#define HAVE_truncsipsi2 (TARGET_CPUX)
#define HAVE_psinybble2 (TARGET_CPUX)
#define HAVE_loadqipsi2 (TARGET_CPUX)
#define HAVE_loadqihi2 1
#define HAVE_storeqi2 1
#define HAVE_movqi 1
#define HAVE_movhi 1
#define HAVE_movpsi (TARGET_CPUX)
#define HAVE_movsi 1
#define HAVE_movsf 1
#define HAVE_movdi 1
#define HAVE_adddi3 1
#define HAVE_addsi3 1
#define HAVE_addpsi3 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_addhi3 1
#define HAVE_addqi3 1
#define HAVE_subdi3 1
#define HAVE_subsi3 1
#define HAVE_subpsi3 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_subhi3 1
#define HAVE_subqi3 1
#define HAVE_one_cmpldi2 1
#define HAVE_one_cmplsi2 1
#define HAVE_one_cmplpsi2 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_one_cmplhi2 1
#define HAVE_one_cmplqi2 1
#define HAVE_negsf2 1
#define HAVE_anddi3 1
#define HAVE_andsi3 1
#define HAVE_andpsi3 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_andhi3 1
#define HAVE_andqi3 1
#define HAVE_iordi3 1
#define HAVE_iorsi3 1
#define HAVE_iorpsi3 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_iorhi3 1
#define HAVE_iorqi3 1
#define HAVE_xordi3 1
#define HAVE_xorsi3 1
#define HAVE_xorpsi3 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_xorhi3 1
#define HAVE_xorqi3 1
#define HAVE_abssf2 1
#define HAVE_setccpsi2 (TARGET_CPUX)
#define HAVE_setcchi2 1
#define HAVE_setccqi2 1
#define HAVE_bittestpsi2 (TARGET_CPUX)
#define HAVE_bittesthi2 1
#define HAVE_bittestqi2 1
#define HAVE_branchcc 1
#define HAVE_ashldi_1 1
#define HAVE_ashlsi_1 1
#define HAVE_ashlpsi_1 (TARGET_CPUX)
#define HAVE_ashlhi_1 1
#define HAVE_ashlqi_1 1
#define HAVE_ashrhi_15 1
#define HAVE_ashrdi_1 1
#define HAVE_ashrsi_1 1
#define HAVE_ashrpsi_1 (TARGET_CPUX)
...
#define HAVE_rlapsi1 (TARGET_CPUX)
#define HAVE_rlahi1 1
#define HAVE_rlaqi1 1
#define HAVE_rlcpsi1 (TARGET_CPUX)
#define HAVE_rlchi1 1
#define HAVE_rlcqi1 1
#define HAVE_rrapsi1 (TARGET_CPUX)
#define HAVE_rrahi1 1
#define HAVE_rraqi1 1
#define HAVE_rrcpsi1 (TARGET_CPUX)
...
#define HAVE_jump 1
#define HAVE_tablejump16 (!msp430x_ext_operand(operands[0], VOIDmode))
...
#define HAVE_extendpsisi2 (TARGET_CPUX)
#define HAVE_extendhidi2 1
#define HAVE_extendhisi2 1
#define HAVE_extendhipsi2 (TARGET_CPUX)
#define HAVE_extendqidi2 1
#define HAVE_extendqisi2 1
#define HAVE_extendqihi2 1
#define HAVE_zero_extendsidi2 1
#define HAVE_zero_extendpsisi2 (TARGET_CPUX)
#define HAVE_zero_extendhidi2 1
#define HAVE_zero_extendhisi2 1
#define HAVE_zero_extendhipsi2 (TARGET_CPUX)
#define HAVE_zero_extendqidi2 1
#define HAVE_zero_extendqisi2 1
#define HAVE_zero_extendqihi2 1
#define HAVE_bswaphi1 1
#define HAVE_pushqi1 1
#define HAVE_pushmpsi2 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_pushmhi2 1
#define HAVE_popmpsi2 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_popmhi2 1
#define HAVE_pushdi1 1
#define HAVE_pushsi1 1
#define HAVE_pushpsi1 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_pushhi1 1
#define HAVE_popdi1 1
#define HAVE_popsi1 1
#define HAVE_poppsi1 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_pophi1 1
#define HAVE_negdi2 1
#define HAVE_negsi2 1
#define HAVE_negpsi2 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_neghi2 1
#define HAVE_negqi2 1
#define HAVE_absdi2 1
#define HAVE_abssi2 1
#define HAVE_abspsi2 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
#define HAVE_abshi2 1
#define HAVE_absqi2 1
#define HAVE_strlenpsi ((TARGET_CPUX || PSImode != PSImode) && (TARGET_D20))
#define HAVE_strlenhi ((TARGET_CPUX || PSImode != HImode) && (!TARGET_D20))
#define HAVE_cbranchdi4 1
#define HAVE_cbranchsi4 1
#define HAVE_cbranchpsi4 ((TARGET_CPUX || PSImode != PSImode) && (TARGET_CPUX))
...
#define HAVE_ashlpsi3 (TARGET_CPUX)
#define HAVE_ashlhi3 1
#define HAVE_ashlqi3 1
#define HAVE_ashlnpsi2 (TARGET_CPUX)
#define HAVE_ashlnhi2 1
#define HAVE_ashlnqi2 1
#define HAVE_ashrdi3 1
#define HAVE_ashrsi3 1
#define HAVE_ashrpsi3 (TARGET_CPUX)
#define HAVE_ashrhi3 1
#define HAVE_ashrqi3 1
#define HAVE_ashrnpsi2 (TARGET_CPUX)
#define HAVE_ashrnhi2 1
#define HAVE_ashrnqi2 1
#define HAVE_lshrdi3 1
#define HAVE_lshrsi3 1
#define HAVE_lshrpsi3 (TARGET_CPUX)
#define HAVE_lshrhi3 1
#define HAVE_lshrqi3 1
#define HAVE_lshrnpsi2 (TARGET_CPUX)
#define HAVE_lshrnhi2 1
#define HAVE_lshrnqi2 1
#define HAVE_lshrpsi_1 (TARGET_CPUX)
#define HAVE_extzv 1
...
extern rtx        gen_extend8bitpsi1              (rtx);
extern rtx        gen_extend8bithi1               (rtx);
extern rtx        gen_truncsipsi2                 (rtx, rtx);
extern rtx        gen_psinybble2                  (rtx, rtx);
extern rtx        gen_loadqipsi2                  (rtx, rtx);
extern rtx        gen_loadqihi2                   (rtx, rtx);
...
extern rtx        gen_setccpsi2                   (rtx, rtx);
extern rtx        gen_setcchi2                    (rtx, rtx);
extern rtx        gen_setccqi2                    (rtx, rtx);
extern rtx        gen_bittestpsi2                 (rtx, rtx);
extern rtx        gen_bittesthi2                  (rtx, rtx);
extern rtx        gen_bittestqi2                  (rtx, rtx);
extern rtx        gen_branchcc                    (rtx, rtx);
extern rtx        gen_ashldi_1                    (rtx);
extern rtx        gen_ashlsi_1                    (rtx);
extern rtx        gen_ashlpsi_1                   (rtx);
...
extern rtx        gen_tablejump16                 (rtx, rtx);
...
extern rtx        gen_pushmpsi2                   (rtx, rtx);
extern rtx        gen_pushmhi2                    (rtx, rtx);
extern rtx        gen_popmpsi2                    (rtx, rtx);
...
extern rtx        gen_abspsi2                     (rtx, rtx);
extern rtx        gen_abshi2                      (rtx, rtx);
extern rtx        gen_absqi2                      (rtx, rtx);
extern rtx        gen_strlenpsi                   (rtx, rtx, rtx, rtx);
...
extern rtx        gen_ashlnpsi2                   (rtx, rtx);
extern rtx        gen_ashlnhi2                    (rtx, rtx);
extern rtx        gen_ashlnqi2                    (rtx, rtx);
extern rtx        gen_ashrdi3                     (rtx, rtx, rtx);
extern rtx        gen_ashrsi3                     (rtx, rtx, rtx);
extern rtx        gen_ashrpsi3                    (rtx, rtx, rtx);
extern rtx        gen_ashrhi3                     (rtx, rtx, rtx);
extern rtx        gen_ashrqi3                     (rtx, rtx, rtx);
extern rtx        gen_ashrnpsi2                   (rtx, rtx);
extern rtx        gen_ashrnhi2                    (rtx, rtx);
extern rtx        gen_ashrnqi2                    (rtx, rtx);
extern rtx        gen_lshrdi3                     (rtx, rtx, rtx);
extern rtx        gen_lshrsi3                     (rtx, rtx, rtx);
extern rtx        gen_lshrpsi3                    (rtx, rtx, rtx);
extern rtx        gen_lshrhi3                     (rtx, rtx, rtx);
extern rtx        gen_lshrqi3                     (rtx, rtx, rtx);
extern rtx        gen_lshrnpsi2                   (rtx, rtx);
extern rtx        gen_lshrnhi2                    (rtx, rtx);
extern rtx        gen_lshrnqi2                    (rtx, rtx);
extern rtx        gen_lshrpsi_1                   (rtx);
